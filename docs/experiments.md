...
| E001-pipe-check-gold58 | 2026-08-31 | gold-58 / 56-58 per plane / 3 fluid planes | 3x frozen resnet34 + linear head | none (in-sample only) | 1.0 in-sample (memorized, expected) | 0.691 | train ~13 min CPU; scoring ~7h wall (queue included) | issue #6, commit 4ef6afc, kernel rsna-knee-train v5 |
...
- **Outcome (scored, 2026-09-01): public LB macro AUC 0.691** — far above the ~0.5 expectation for 56-58 training studies. Frozen ImageNet features + uniform 3-plane averaging carry real signal even at tiny n. Sets the baseline for the E002 combiner A/B.
